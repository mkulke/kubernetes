...
func NewStorage(opts generic.RESTOptions, k client.ConnectionInfoGetter, proxyTransport http.RoundTripper, resolveHost pod.HostnameResolver) PodStorage {
	prefix := "/pods"
	...
	return PodStorage{
		...
		Log:         &podrest.LogREST{Store: store, KubeletConn: k, HostnameResolver: resolveHost},
