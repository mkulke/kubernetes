...
import (
	...
	"k8s.io/kubernetes/pkg/auth/authorizer/abac/api/v1"
...
func TestAuthorizeV1(t *testing.T) {
	a, err := newWithContents(t,
		`
		 # Comment line, after a blank line
		 {"apiVersion":"abac.authorization.kubernetes.io/v1","kind":"Policy","user":"*",         "readonly": true,                                                        "nonResourcePath": "/api"}
		 {"apiVersion":"abac.authorization.kubernetes.io/v1","kind":"Policy","user":"*",                                                                                  "nonResourcePath": "/custom"}
		 {"apiVersion":"abac.authorization.kubernetes.io/v1","kind":"Policy","user":"*",                                                                                  "nonResourcePath": "/root/*"}
		 {"apiVersion":"abac.authorization.kubernetes.io/v1","kind":"Policy","user":"noresource",                                                                         "nonResourcePath": "*"}
		 {"apiVersion":"abac.authorization.kubernetes.io/v1","kind":"Policy","user":"*",         "readonly": true, "resource": "events",   "namespace": "*"}
		 {"apiVersion":"abac.authorization.kubernetes.io/v1","kind":"Policy","user":"scheduler", "readonly": true, "resource": "pods",     "namespace": "*"}
		 {"apiVersion":"abac.authorization.kubernetes.io/v1","kind":"Policy","user":"scheduler",                   "resource": "bindings", "namespace": "*"}
		 {"apiVersion":"abac.authorization.kubernetes.io/v1","kind":"Policy","user":"kubelet",   "readonly": true, "resource": "bindings", "namespace": "*"}
		 {"apiVersion":"abac.authorization.kubernetes.io/v1","kind":"Policy","user":"kubelet",                     "resource": "events",   "namespace": "*"}
		 {"apiVersion":"abac.authorization.kubernetes.io/v1","kind":"Policy","user":"alice",                       "resource": "*",        "namespace": "projectCaribou"}
		 {"apiVersion":"abac.authorization.kubernetes.io/v1","kind":"Policy","user":"bob",       "readonly": true, "resource": "*",        "namespace": "projectCaribou"}
		 {"apiVersion":"abac.authorization.kubernetes.io/v1","kind":"Policy","user":"debbie",                      "resource": "pods",     "namespace": "projectCaribou"}
		 {"apiVersion":"abac.authorization.kubernetes.io/v1","kind":"Policy","user":"apigroupuser",                "resource": "*",        "namespace": "projectAnyGroup",   "resourceGroup": "*"}
		 {"apiVersion":"abac.authorization.kubernetes.io/v1","kind":"Policy","user":"apigroupuser",                "resource": "*",        "namespace": "projectEmptyGroup", "resourceGroup": "" }
		 {"apiVersion":"abac.authorization.kubernetes.io/v1","kind":"Policy","user":"apigroupuser",                "resource": "*",        "namespace": "projectXGroup",     "resourceGroup": "x"}`)
